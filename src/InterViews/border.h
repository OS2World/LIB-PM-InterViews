...
public:
    HBorder(long thick = 1);
    HBorder(const char*, long thick = 1);
    HBorder(Painter* out, long thick = 1);
protected:
...
public:
    VBorder(long thick = 1);
    VBorder(const char*, long thick = 1);
    VBorder(Painter* out, long thick = 1);
protected:
    virtual void Reconfig();
private:
    void Init();
